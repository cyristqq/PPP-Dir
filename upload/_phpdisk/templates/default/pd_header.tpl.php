...
#
#	$Id: pd_header.tpl.php 30 2024-12-10 13:26:02Z along $
#
...
<head>
	...
	<!--plugins-->
	<link href="{$user_tpl_dir}assets/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet" />	
	<!-- Bootstrap CSS -->
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{$user_tpl_dir}assets/css/dark-theme.css" />
	<link rel="stylesheet" href="{$user_tpl_dir}assets/css/semi-dark.css" />
	<link rel="stylesheet" href="{$user_tpl_dir}assets/css/header-colors.css" />
	...
	<div class="container-fluid">
		<div class="row bg-dark">
			<nav class="navbar navbar-expand-lg navbar-dark rounded">
						<div class="container">
						<a class="navbar-brand mb-1" href="./" title="{$settings['site_title']}"><img src="{$user_tpl_dir}images/logo.png" align="absmiddle" border="0" alt="{$settings['site_title']}" id="logo"></a>
